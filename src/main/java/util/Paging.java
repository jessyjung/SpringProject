...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='/jung/resources/img/btn_prev.gif'></a>");	//"'><img src='../btn_prev.gif></a>"
		}
		else
			sb.append("<img src='/jung/resources/img/btn_prev.gif'>");	//("<img src='../btn_prev.gif>")
...
//------페이지 목록 출력 -------------------------------------------------------------------------------------------------
		...
		for(int i=startPage; i<= endPage ;i++){
			...
			if(i == nowPage){ //현재 있는 페이지
				sb.append("&nbsp;<b><font color='#f00'>");	//선택되어 있는 페이지
				sb.append(i);
				sb.append("</font></b>");
			}
			else{//현재 페이지가 아니면
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='/jung/resources/img/btn_next.gif'></a>");
		}
		else
			sb.append("<img src='/jung/resources/img/btn_next.gif'>");
//---------------------------------------------------------------------------------------------------------------------	    
